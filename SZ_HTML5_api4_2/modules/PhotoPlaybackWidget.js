...
//  var photo_play_timer = false;
  ...
  function load_NOAA_Photo(new_img_src) {
    if (!justAK)
      return;
    setMessage("photoNoImageMessage", {"visible": true, "text": "Image not found on Picasa.  Trying the NOAA server...", "fade": 1000});
  ...
  function processPicasaData(response) {
    ...
    photoWidth = document.getElementById("photoImage").width;
