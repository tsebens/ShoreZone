  ...
  return declare(QueryBasedPanelWidget, {
    ...
    setPlaybackOn: function(play) {
      ...
      if (youtube_ready()) {
        ...
        if (play) setMessage("videoNoImageMessage",{"visible": true, "text": "Loading video..."});
      } else {
    ...
    constructor: function(/*Object*/ kwArgs){
      ...
      this.setPlaybackRate = function(playbackRate, lowest, highest) {
        ...
        document.getElementById("playbackRateLabel").innerText = playbackRate + "X";
        document.getElementById("decrSpeedIcon").innerText = (lowest?" ":"-   ");
        document.getElementById("incrSpeedIcon").innerText = (highest?" ":"   +");
      };
      ...
      this.setSyncPhotos = function(synced) {
        ...
        photoToolsDivStyle = document.getElementById("photoToolsDiv").style;
      ...
      videoToolsDiv.innerHTML = makeMediaPlaybackHtml(playbackControlTemplate, controlData_video) + speedHTML + linkHTML;
